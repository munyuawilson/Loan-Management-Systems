...
<head>
    ...
    <title>LoanTrack Pro - Modern Shop Loan Management</title>
...
<body class="bg-white">
    ...
    <nav class="fixed w-full bg-white z-50 shadow-sm border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    <a href="#" class="text-gray-700 hover:text-red-600 transition-colors font-medium hidden md:block">Sign In</a>
                    <a href="#" class="btn-primary text-white px-6 py-2.5 rounded-lg font-medium">Get Started</a>
        ...
        <div class="md:hidden hidden bg-white border-t border-gray-100" id="mobile-menu">
            <div class="px-4 py-4 space-y-4">
                ...
                <a href="#" class="block text-gray-700 hover:text-red-600 transition-colors font-medium">Sign In</a>
            </div>
        </div>
    </nav>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="fade-in">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                        ...
                        <span class="accent-red">Modern Shops</span>
                    </h1>
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-4">
                        <a href="#" class="btn-primary text-white px-8 py-4 rounded-lg font-semibold text-lg text-center">
                            Start Free Trial
                        </a>
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                        <div>
                                            <div class="font-medium text-gray-900">Ahmed Store</div>
                                            <div class="text-sm text-gray-500">Payment received</div>
                                        </div>
                                        <div class="text-green-600 font-semibold">+$200</div>
                                    </div>
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                        <div>
                                            <div class="font-medium text-gray-900">Maria Fashion</div>
                                            <div class="text-sm text-gray-500">New loan created</div>
                                        </div>
                                        <div class="text-red-600 font-semibold">-$500</div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section id="features" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center fade-in">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Designed for Shop Owners</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
                ...
                <div class="feature-card bg-white rounded-xl p-8 border border-gray-100 fade-in">
                    <div class="w-16 h-16 bg-red-50 rounded-xl flex items-center justify-center mb-6">
                        <i class="fas fa-money-check-alt text-red-600 text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Payment Processing</h3>
                    <p class="text-gray-600">Record customer payments and automatically update loan balances in real-time.</p>
                </div>
                ...
                <div class="feature-card bg-white rounded-xl p-8 border border-gray-100 fade-in">
                    ...
                    <p class="text-gray-600">Receive timely notifications for due payments, completed loans, and important updates.</p>
                </div>
                ...
                <div class="feature-card bg-white rounded-xl p-8 border border-gray-100 fade-in">
                    ...
                    <p class="text-gray-600">Access your loan management system from any device, anywhere with internet connection.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="solutions" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <!-- Content -->
                <div class="fade-in">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Perfect for All Types of Shops</h2>
                    ...
                    <div class="mt-8 space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900">Setup in Minutes</h4>
    ...
    <section id="testimonials" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center fade-in">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Trusted by Shop Owners</h2>
                <p class="text-xl text-gray-600 mt-4">See how LoanTrack is transforming small businesses</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
                ...
                <div class="testimonial-card rounded-xl p-8 fade-in">
                    <div class="flex items-center mb-6">
                        <div class="w-14 h-14 bg-red-100 rounded-full flex items-center justify-center text-red-600 font-bold text-lg mr-4">
                            AS
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-900">Ahmed Store</h4>
                            <p class="text-gray-500 text-sm">Grocery & General Store</p>
                        </div>
                    </div>
                    <p class="text-gray-600">
                        "We've reduced our loan tracking time by 80%. What used to take hours with paper records now takes minutes with LoanTrack."
                    </p>
                ...
                <div class="testimonial-card rounded-xl p-8 fade-in">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900">Maria Fashion</h4>
                            <p class="text-gray-500 text-sm">Clothing Boutique</p>
                        </div>
                    </div>
                    <p class="text-gray-600">
                        "The payment tracking feature has eliminated all disputes with customers. Everyone can see the clear payment history."
                    </p>
                    <div class="flex text-red-400 mt-4">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="testimonial-card rounded-xl p-8 fade-in">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900">ElectroShop</h4>
                            <p class="text-gray-500 text-sm">Electronics Retailer</p>
                        </div>
                    </div>
                    <p class="text-gray-600">
                        "Our loan recovery rate improved from 75% to 94% after implementing LoanTrack. The reminder system works perfectly."
                    </p>
                    <div class="flex text-red-400 mt-4">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-16">
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-200 fade-in hover:border-red-300 transition-colors">
                    ...
                    <a href="#" class="block w-full bg-gray-100 text-gray-800 py-3 rounded-lg font-semibold text-center hover:bg-gray-200 transition-colors">
                        Get Started Free
                    </a>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 border-2 border-red-500 shadow-lg fade-in relative">
                    ...
                    <a href="#" class="block w-full bg-red-600 text-white py-3 rounded-lg font-semibold text-center hover:bg-red-700 transition-colors">
    ...
    <section class="py-20 bg-white border-t border-gray-100">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">Join hundreds of shop owners who have transformed their business with LoanTrack Pro</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#" class="btn-primary text-white px-8 py-4 rounded-lg font-semibold text-lg">
                    Start Free Trial
                </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p class="text-gray-400">Modern loan management solutions for forward-thinking shop owners.</p>
                </div>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2024 LoanTrack Pro. All rights reserved. Built for shop owners worldwide.</p>
            </div>
        </div>
    </footer>
